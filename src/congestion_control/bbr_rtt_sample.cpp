...
bool BbrRttSampler::newRttSample(std::chrono::microseconds rttSample, TimePoint sampledTime) noexcept {
    rttSampleExpired_ = minRttTimestamp_.has_value() ? sampledTime > *minRttTimestamp_ + expiration_ : false;
