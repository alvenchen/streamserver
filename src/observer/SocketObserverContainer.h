...
using SocketObserverContainerBaseT = folly::ObserverContainer<SocketObserverInterface, QuicSocket, 
    folly::ObserverContainerBasePolicyDefault<SocketObserverInterface::Events /* EventEnum */, 32 /* BitsetSize (max number of interface events) */>>;
