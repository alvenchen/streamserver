...
public:
    ...
    struct CloseStartedEvent {
        ...
        // unit tests and other code that we expect to run in C++20.
            ...
            friend auto operator<=>(const CloseStartedEvent&, const CloseStartedEvent&) = default;
        #elif _WIN32
            friend auto operator!=(const CloseStartedEvent& right, const CloseStartedEvent& left) {
    ...
    struct WriteEvent {
        ...
        struct BuilderFields {
            folly::Optional<std::reference_wrapper<const std::deque<OutstandingPacketWrapper>>> maybeOutstandingPacketsRef;
        ...
        struct Builder : public BuilderFields {
            Builder&& setOutstandingPackets(const std::deque<OutstandingPacketWrapper>& outstandingPacketsIn);
            Builder&& setWriteCount(const uint64_t writeCountIn);
            Builder&& setLastPacketSentTime(const TimePoint& lastPacketSentTimeIn);
            Builder&& setLastPacketSentTime(const folly::Optional<TimePoint>& maybeLastPacketSentTimeIn);
            Builder&& setCwndInBytes(const folly::Optional<uint64_t>& maybeCwndInBytesIn);
            Builder&& setWritableBytes(const folly::Optional<uint64_t>& maybeWritableBytesIn);
            WriteEvent build() &&;
    ...
    struct PacketsWrittenEvent : public WriteEvent {
         ...
         * function.
         */
        void invokeForEachNewOutstandingPacketOrdered(const std::function<void(const OutstandingPacketWrapper&)>& fn) const;
        ...
        struct Builder : public BuilderFields {
            ...
            Builder&& setNumAckElicitingPacketsWritten(const uint64_t numAckElicitingPacketsWrittenIn);
    ...
    struct AcksProcessedEvent {
        ...
        struct BuilderFields {
            folly::Optional<std::reference_wrapper<const std::vector<AckEvent>>> maybeAckEventsRef;
            explicit BuilderFields() = default;
        };
    ...
    struct LostPacket {
        explicit LostPacket(bool lostByTimeout, bool lostByReorderThreshold,
            quic::OutstandingPacketMetadata pktMetadata, quic::PacketNum packetNum, quic::PacketNumberSpace pnSpace)
            : lostByTimeout(lostByTimeout), lostByReorderThreshold(lostByReorderThreshold),
                packetMetadata(std::move(pktMetadata)), packetNum(packetNum), pnSpace(pnSpace) {
        }
    ...
    struct LossEvent {
        ...
        void addLostPacket(
            const quic::OutstandingPacketMetadata& pktMetadata, const quic::PacketNum packetNum,
            const quic::PacketNumberSpace pnSpace) {
            lostPackets.emplace_back(pktMetadata.lossTimeoutDividend.has_value(),
                pktMetadata.lossReorderDistance.has_value(), pktMetadata, packetNum, pnSpace);
        }
    ...
    struct PacketRTT {
        explicit PacketRTT(TimePoint rcvTimeIn, std::chrono::microseconds rttSampleIn,
            std::chrono::microseconds ackDelayIn, const quic::OutstandingPacketWrapper& pkt)
            : rcvTime(rcvTimeIn), rttSample(rttSampleIn), ackDelay(ackDelayIn),
                metadata(pkt.metadata), lastAckedPacketInfo(pkt.lastAckedPacketInfo) {
        }
        TimePoint rcvTime;
        std::chrono::microseconds rttSample;
        std::chrono::microseconds ackDelay;
        const quic::OutstandingPacketMetadata metadata;
        const folly::Optional<OutstandingPacketWrapper::LastAckedPacketInfo> lastAckedPacketInfo;
    };
    ...
    struct SpuriousLossEvent {
        ...
        void addSpuriousPacket(const quic::OutstandingPacketMetadata& pktMetadata,
            const quic::PacketNum packetNum, const quic::PacketNumberSpace pnSpace) {
            spuriousPackets.emplace_back(pktMetadata.lossTimeoutDividend.has_value(),
                pktMetadata.lossReorderDistance.has_value(), pktMetadata, packetNum, pnSpace);
        }
    ...
    struct StreamEvent {
        StreamEvent(const StreamId id, StreamInitiator initiator, StreamDirectionality directionality)
            : streamId(id), streamInitiator(initiator), streamDirectionality(directionality) {}
     ...
     */
    virtual void closeStarted(QuicSocket* /* socket */, const CloseStartedEvent& /* event */) noexcept {}
     ...
     */
    virtual void closing(QuicSocket* /* socket */, const ClosingEvent& /* event */) noexcept {}
     ...
     */
    virtual void evbAttach(QuicSocket* /* socket */, folly::EventBase* /* evb */) noexcept {}
     ...
     */
    virtual void evbDetach(QuicSocket* /* socket */, folly::EventBase* /* evb */) noexcept {}
     ...
     */
    virtual void startWritingFromAppLimited(QuicSocket* /* socket */, const AppLimitedEvent& /* event */) {}
     ...
     */
    virtual void packetsWritten(QuicSocket* /* socket */, const PacketsWrittenEvent& /* event */) {}
     ...
     * @param event    AppLimitedEvent with details.
     */
    virtual void appRateLimited(QuicSocket* /* socket */, const AppLimitedEvent& /* event */) {}
     ...
     */
    virtual void packetsReceived(QuicSocket* /* socket */, const PacketsReceivedEvent& /* event */) {}
     ...
     */
    virtual void acksProcessed(QuicSocket* /* socket */, const struct AcksProcessedEvent& /* event */) {}
     ...
     */
    virtual void packetLossDetected(QuicSocket* /* socket */, const LossEvent& /* event */) {}
     ...
     */
    virtual void rttSampleGenerated(QuicSocket* /* socket */, const PacketRTT& /* event */) {}
     ...
     */
    virtual void spuriousLossDetected(QuicSocket*, /* socket */ const SpuriousLossEvent& /* event */) {}
     ...
     */
    virtual void knobFrameReceived(QuicSocket*, /* socket */ const KnobFrameEvent& /* event */) {}
     ...
     */
    virtual void streamOpened(QuicSocket*, /* socket */ const StreamOpenEvent& /* event */) {}
     ...
     * @param event    Event containing details.
     */
    virtual void streamClosed(QuicSocket*, /* socket */ const StreamCloseEvent& /* event */) {}
};
