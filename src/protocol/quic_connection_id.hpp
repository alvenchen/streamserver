...
struct ConnectionIdData {
    ...
    ConnectionIdData(
        const ConnectionId& connIdIn, uint64_t sequenceNumberIn, StatelessResetToken tokenIn)
...
struct ServerConnectionIdParams {
    explicit ServerConnectionIdParams(uint32_t hostIdIn, uint8_t processIdIn, uint8_t workerIdIn)
        : ServerConnectionIdParams(ConnectionIdVersion::V1, hostIdIn, processIdIn, workerIdIn) {}

    explicit ServerConnectionIdParams(ConnectionIdVersion versionIn, uint32_t hostIdIn, uint8_t processIdIn, uint8_t workerIdIn) {
...
bool operator==(const ServerConnectionIdParams& lhs, const ServerConnectionIdParams& rhs);
