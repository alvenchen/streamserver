...
using StatelessResetSecret = std::array<uint8_t, kStatelessResetTokenSecretLength>;
...
public:
    explicit StatelessResetGenerator(StatelessResetSecret secret, const std::string& addressStr);
