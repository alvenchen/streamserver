...
struct AckEvent {
    ...
    struct AckPacket {
        ...
        struct StreamDetails {
            ...
            using DupAckedStreamIntervals = IntervalSet<uint64_t, 1, DupAckedStreamIntervalSetVec>;
        ...
        class DetailsPerStream : private MapType {
             ...
             */
            void recordFrameDelivered(const WriteStreamFrame& frame, const bool retransmission);
             ...
             *                       packet reordering.
             */
            void recordFrameAlreadyDelivered(const WriteStreamFrame& frame, const bool retransmission);
        ...
        folly::Optional<OutstandingPacketWrapper::LastAckedPacketInfo> lastAckedPacketInfo;
        ...
        struct Builder {
            ...
            Builder&& setNonDsrPacketSequenceNumber(uint64_t nonDsrPacketSequenceNumberIn);
            ...
            Builder&& setLastAckedPacketInfo(folly::Optional<OutstandingPacketWrapper::LastAckedPacketInfo>&& lastAckedPacketInfoIn);
            Builder&& setAppLimited(bool appLimitedIn);
            Builder&& setReceiveDeltaTimeStamp(folly::Optional<std::chrono::microseconds>&& receiveRelativeTimeStampUsec);
            AckPacket build() &&;
    ...
    private:
        explicit AckPacket(quic::PacketNum packetNumIn, uint64_t nonDsrPacketSequenceNumberIn,
            OutstandingPacketMetadata&& outstandingPacketMetadataIn, DetailsPerStream&& detailsPerStreamIn,
            folly::Optional<OutstandingPacketWrapper::LastAckedPacketInfo> lastAckedPacketInfoIn,
            bool isAppLimitedIn, folly::Optional<std::chrono::microseconds>&& receiveRelativeTimeStampUsec);
    };
