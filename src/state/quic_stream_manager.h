...
public:
    explicit QuicStreamManager(QuicConnectionStateBase& conn, QuicNodeType nodeType, const TransportSettings& transportSettings)
        ...
        writeQueue_.setMaxNextsPerStream(transportSettings.priorityQueueWritesPerStream);
    }
     ...
     */
    explicit QuicStreamManager(QuicConnectionStateBase& conn, QuicNodeType nodeType, const TransportSettings& transportSettings, QuicStreamManager&& other)
        : conn_(conn), nodeType_(nodeType), transportSettings_(&transportSettings) {
        
        nextAcceptablePeerBidirectionalStreamId_ = other.nextAcceptablePeerBidirectionalStreamId_;
        nextAcceptablePeerUnidirectionalStreamId_ = other.nextAcceptablePeerUnidirectionalStreamId_;
        nextAcceptableLocalBidirectionalStreamId_ = other.nextAcceptableLocalBidirectionalStreamId_;
        nextAcceptableLocalUnidirectionalStreamId_ = other.nextAcceptableLocalUnidirectionalStreamId_;
        ...
        initialLocalUnidirectionalStreamId_ = other.initialLocalUnidirectionalStreamId_;
        initialRemoteBidirectionalStreamId_ = other.initialRemoteBidirectionalStreamId_;
        initialRemoteUnidirectionalStreamId_ = other.initialRemoteUnidirectionalStreamId_;

        streamLimitWindowingFraction_ = other.streamLimitWindowingFraction_;
        remoteBidirectionalStreamLimitUpdate_ = other.remoteBidirectionalStreamLimitUpdate_;
        remoteUnidirectionalStreamLimitUpdate_ = other.remoteUnidirectionalStreamLimitUpdate_;
        numControlStreams_ = other.numControlStreams_;
        openBidirectionalPeerStreams_ = std::move(other.openBidirectionalPeerStreams_);
        openUnidirectionalPeerStreams_ = std::move(other.openUnidirectionalPeerStreams_);
        openBidirectionalLocalStreams_ = std::move(other.openBidirectionalLocalStreams_);
        openUnidirectionalLocalStreams_ = std::move(other.openUnidirectionalLocalStreams_);
        openBidirectionalLocalStreamGroups_ = std::move(other.openBidirectionalLocalStreamGroups_);
        openUnidirectionalLocalStreamGroups_ = std::move(other.openUnidirectionalLocalStreamGroups_);
        ...
        maxLocalBidirectionalStreamIdIncreased_ = other.maxLocalBidirectionalStreamIdIncreased_;
        maxLocalUnidirectionalStreamIdIncreased_ = other.maxLocalUnidirectionalStreamIdIncreased_;
        ...
        for (auto& pair : other.streams_) {
            streams_.emplace(std::piecewise_construct, std::forward_as_tuple(pair.first),
                std::forward_as_tuple(/* migrate state to new conn ref */ conn_, std::move(pair.second)));
        }
    }
    /*
    ...
    */
    folly::Expected<QuicStreamState*, LocalErrorCode> createStream(StreamId streamId,
        folly::Optional<StreamGroupId> streamGroupId = folly::none);

    /*
    * Create a new bidirectional stream group.
    */
    folly::Expected<StreamGroupId, LocalErrorCode> createNextBidirectionalStreamGroup();

    /*
    * Create and return the state for the next available bidirectional stream.
    */
    folly::Expected<QuicStreamState*, LocalErrorCode>
    createNextBidirectionalStream(folly::Optional<StreamGroupId> streamGroupId = folly::none);

    /*
    * Create a new unidirectional stream group.
    */
    folly::Expected<StreamGroupId, LocalErrorCode> createNextUnidirectionalStreamGroup();

    /*
    * Create and return the state for the next available unidirectional stream.
    */
    folly::Expected<QuicStreamState*, LocalErrorCode>
    createNextUnidirectionalStream(folly::Optional<StreamGroupId> streamGroupId = folly::none);
    ...
    */
    QuicStreamState* FOLLY_NULLABLE getStream(StreamId streamId, folly::Optional<StreamGroupId> streamGroupId = folly::none);
    ...
    */
    ...
    uint64_t openableLocalBidirectionalStreams() {
        //CHECK_GE(maxLocalBidirectionalStreamId_,nextAcceptableLocalBidirectionalStreamId_);
        return (maxLocalBidirectionalStreamId_ - nextAcceptableLocalBidirectionalStreamId_) / detail::kStreamIncrement;
    }

    uint64_t openableLocalUnidirectionalStreams() {
        //CHECK_GE(maxLocalUnidirectionalStreamId_, nextAcceptableLocalUnidirectionalStreamId_);
        return (maxLocalUnidirectionalStreamId_ - nextAcceptableLocalUnidirectionalStreamId_) / detail::kStreamIncrement;
    }

    uint64_t openableRemoteBidirectionalStreams() {
        //CHECK_GE(maxRemoteBidirectionalStreamId_, nextAcceptablePeerBidirectionalStreamId_);
        return (maxRemoteBidirectionalStreamId_ - nextAcceptablePeerBidirectionalStreamId_) / detail::kStreamIncrement;
    }

    uint64_t openableRemoteUnidirectionalStreams() {
        //CHECK_GE(maxRemoteUnidirectionalStreamId_, nextAcceptablePeerUnidirectionalStreamId_);
        //return (maxRemoteUnidirectionalStreamId_ - nextAcceptablePeerUnidirectionalStreamId_) / detail::kStreamIncrement;
    }
    ...
    * unless force is true.
    */
    void setMaxLocalUnidirectionalStreams(uint64_t maxStreams, bool force = false);
    ...
    */
    auto consumeFlowControlUpdated(std::vector<StreamId>&& storage) {
        ...
        result.insert(result.end(), flowControlUpdated_.begin(), flowControlUpdated_.end());
    ...
    */
    auto consumeStopSending() {
        ...
        result.insert(result.end(), stopSendingStreams_.begin(), stopSendingStreams_.end());
...
private:
    ...
    QuicStreamState* FOLLY_NULLABLE getOrCreateOpenedLocalStream(StreamId streamId);

    QuicStreamState* FOLLY_NULLABLE getOrCreatePeerStream(StreamId streamId,
        folly::Optional<StreamGroupId> streamGroupId = folly::none);

    void setMaxRemoteBidirectionalStreamsInternal(uint64_t maxStreams, bool force);
    void setMaxRemoteUnidirectionalStreamsInternal(uint64_t maxStreams, bool force);
    ...
    QuicStreamState* FOLLY_NULLABLE instantiatePeerStream(StreamId streamId, folly::Optional<StreamGroupId> groupId);

    folly::Expected<StreamGroupId, LocalErrorCode> createNextStreamGroup(StreamGroupId& groupId,
        folly::F14FastSet<StreamGroupId>& streamGroups);

    /*
    * Helper to consume new stream ids.
    */
    std::vector<StreamId> swapStreams(std::vector<StreamId>& src, std::vector<StreamId>&& dst) {
