...
StreamDirectionality getStreamDirectionality(StreamId stream) {
    return isUnidirectionalStream(stream) ? StreamDirectionality::Unidirectional : StreamDirectionality::Bidirectional;
}
...
StreamInitiator getStreamInitiator(QuicNodeType nodeType, StreamId stream) {
    return isLocalStream(nodeType, stream) ? StreamInitiator::Local : StreamInitiator::Remote;
}
