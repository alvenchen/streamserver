...
struct TransportSettings {
    ...
    uint64_t advertisedInitialBidiRemoteStreamWindowSize{kDefaultStreamWindowSize};
    ...
    CongestionControlType defaultCongestionController{CongestionControlType::Cubic};
    ...
    std::chrono::microseconds pacingTimerResolution{kDefaultPacingTimerResolution};
    ZeroRttSourceTokenMatchingPolicy zeroRttSourceTokenMatchingPolicy{ZeroRttSourceTokenMatchingPolicy::REJECT_IF_NO_EXACT_MATCH};
    ...
    uint64_t writeConnectionDataPacketsLimit{kDefaultWriteConnectionDataPacketLimit};
    ...
    uint64_t rxPacketsBeforeAckInitThreshold{kDefaultRxPacketsBeforeAckInitThreshold};
    ...
    folly::Optional<std::array<uint8_t, kStatelessResetTokenSecretLength>> statelessResetTokenSecret;
    // retry token secret used for encryption/decryption
    folly::Optional<std::array<uint8_t, kRetryTokenSecretLength>> retryTokenSecret;
    // Default initial RTT
    ...
    DurationRep timeReorderingThreshDividend{kDefaultTimeReorderingThreshDividend};
    ...
    // supports them.
    folly::Optional<AckReceiveTimestampsConfig> maybeAckReceiveTimestampsConfigSentToPeer;
};
